                        ...
                        <div class="p-2 mt-2 overflow-hidden text-xs rounded-md bg-gray-50 dark:bg-gray-700">
                            <div class="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
                                <div class="flex items-center space-x-1 text-gray-700 dark:text-gray-300">
                                    ...
                                    <span class="font-semibold">{{ $totalManchettesCount }}</span>
                                    <span>/{{ $totalEtudiantsExpected }} manchettes</span>
                                </div>
                                <div class="flex items-center space-x-1 text-gray-700 dark:text-gray-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                    </svg>
                                    <span>Par vous: <span class="font-semibold">{{ $userManchettesCount }}</span></span>
                                </div>
                            </div>
                        </div>
                    @endif --}}
