<div>
    <div class="container px-4 py-6 mx-auto">
        <!-- En-tête avec titre et indicateur de session -->
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    @if($sessionActive && $sessionActive->type === 'Rattrapage' && $examen)
                        <!-- Bouton spécial pour rattrapage -->
                        <button wire:click="diagnosticEligiblesRattrapage" class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-orange-700 bg-orange-50 border border-orange-300 rounded-md shadow-sm hover:bg-orange-100 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 dark:bg-orange-900 dark:text-orange-200 dark:border-orange-600 dark:hover:bg-orange-800">
        ...
        <!-- Message d'information pour les sessions de rattrapage -->
        @if($sessionActive && $sessionActive->type === 'Rattrapage' && $examen)
            @php
        ...
        <div class="mb-6 overflow-hidden bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <!-- Barre de progression avec indicateur de session -->
        ...
        @else
            <!-- Message quand aucun examen n'est sélectionné -->
            <div class="py-12 text-center">
                <svg class="w-12 h-12 mx-auto text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                </svg>
                <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">Aucun examen sélectionné</h3>
