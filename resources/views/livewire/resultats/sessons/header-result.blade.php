...
<div class="mb-6">
                ...
                <div class="flex items-center mt-1 space-x-2">
                    @if($sessionNormale)
                        ...
                        <div class="flex items-center px-2 py-1 text-xs font-medium {{ $deliberationS1 ? 'text-green-700 bg-green-100 dark:text-green-300 dark:bg-green-900/30' : 'text-blue-700 bg-blue-100 dark:text-blue-300 dark:bg-blue-900/30' }} rounded-full">
                            ...
                            <span>{{ $sessionNormale->type }} ({{ $sessionNormale->libelle ?? 'Session 1' }}) - {{ $deliberationS1 ? 'Délibérée' : 'En cours' }}</span>
                        </div>
                    @endif
    ...
    {{-- Bannière d'information délibération --}}
    @if($selectedNiveau && $selectedAnneeUniversitaire)
        ...
        @if($sessionDeliberee)
            <div class="p-4 mt-4 border border-green-200 bg-green-50 dark:bg-green-900/20 dark:border-green-700 rounded-xl">
                <div class="flex items-center">
                    <em class="mr-3 text-green-600 ni ni-shield-check dark:text-green-400"></em>
                    <div>
                        <h4 class="text-sm font-medium text-green-900 dark:text-green-100">Délibération Active</h4>
                        <p class="text-sm text-green-700 dark:text-green-300">
                            Une ou plusieurs sessions ont été délibérées. Les décisions du jury sont appliquées.
                        </p>
                    </div>
                </div>
            </div>
        @elseif($sessionsEnAttente)
            <div class="p-4 mt-4 border border-orange-200 bg-orange-50 dark:bg-orange-900/20 dark:border-orange-700 rounded-xl">
                <div class="flex items-center">
                    <em class="mr-3 text-orange-600 ni ni-clock dark:text-orange-400"></em>
                    <div>
                        <h4 class="text-sm font-medium text-orange-900 dark:text-orange-100">Sessions en Attente</h4>
                        <p class="text-sm text-orange-700 dark:text-orange-300">
                            Des sessions avec résultats sont en attente de délibération. Vous pouvez utiliser l'onglet "Paramètres" pour configurer et appliquer une délibération.
                        </p>
                    </div>
                </div>
            </div>
