            ...
            <div class="space-y-4">
                @if(empty($resultatsSession1))
                    <div class="py-12 text-center">
                        ...
                        <p class="mt-4 text-lg text-gray-500 dark:text-gray-400">Aucun résultat publié pour la 1ère session</p>
                        <p class="text-sm text-gray-400 dark:text-gray-500">Vérifiez vos filtres ou que les résultats ont bien été publiés</p>
                    </div>
                @else
                    ...
                    <div class="p-4 border border-blue-200 bg-blue-50 dark:bg-blue-900/20 dark:border-blue-700 rounded-xl">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-blue-700 dark:text-blue-300">Les résultats de la session normale sont publiés et verrouillés. Aucune modification possible.</p>
                            </div>
                        </div>
                    </div>

                    {{-- Tableau Session 1 avec votre logique existante --}}
