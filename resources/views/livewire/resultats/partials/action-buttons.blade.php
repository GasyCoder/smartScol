    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
        ...
        >
            <span class="flex items-center justify-center gap-2">
                {{-- Icône statique --}}
                <svg wire:loading.remove wire:target="simulerDeliberation" 
                     class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                </svg>

                {{-- Spinner pendant loading --}}
                <svg wire:loading wire:target="simulerDeliberation" 
            ...
            <div class="grid grid-cols-2 gap-2">
                ...
                >
                    <span class="flex items-center justify-center gap-1.5">
                        {{-- Icône statique --}}
                        <svg wire:loading.remove wire:target="appliquerDeliberation" 
                             class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                        </svg>

                        {{-- Spinner pendant loading --}}
                        <svg wire:loading wire:target="appliquerDeliberation" 
                             class="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                        </svg>
                ...
                >
                    <span class="flex items-center justify-center gap-1.5">
                        {{-- Icône statique --}}
                        <svg wire:loading.remove wire:target="annulerSimulation" 
                             class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                        </svg>

                        {{-- Spinner pendant loading --}}
                        <svg wire:loading wire:target="annulerSimulation" 
                             class="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                        </svg>
