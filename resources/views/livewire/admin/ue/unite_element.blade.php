<div class="relative">
    ...
    <div class="sticky top-0 z-10 px-5 py-4 bg-white border-b border-gray-200 shadow-sm dark:bg-gray-900 dark:border-gray-800">
        <div class="flex items-center justify-between">
            <!-- Titre principal -->
            <h5 class="text-xl font-medium text-slate-700 dark:text-white">Unité d'enseignement</h5>
    ...
    <div class="px-5 pt-6">
        ...
        <div class="[&:not(:last-child)]:pb-7 lg:[&:not(:last-child)]:pb-14">
            <div id="niveau-section" class="pb-5">
                ...
                <p class="mb-5 text-sm leading-6 text-slate-400">
                    Veuillez sélectionner le niveau d'étude pour lequel vous souhaitez ajouter une unité d'enseignement.
                </p>
            </div>
        ...
        <div class="[&:not(:last-child)]:pb-7 lg:[&:not(:last-child)]:pb-14">
            <div id="parcours-section" class="pb-5">
                ...
                <p class="mb-5 text-sm leading-6 text-slate-400">
                    Veuillez sélectionner le parcours pour lequel vous souhaitez ajouter une unité d'enseignement.
                </p>
            </div>
        ...
        @if($step === 'ue' && $niveauInfo && $parcoursInfo)
        <div>
            <div class="flex flex-col mb-6 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    {{-- <h5 class="text-lg font-medium -tracking-snug text-slate-700 dark:text-white leading-tighter">Unités d'enseignement</h5> --}}
                    <p class="mt-1 text-sm font-bold leading-6 text-slate-400">
                        Liste des unités d'enseignement pour {{ $niveauInfo['nom'] }} - {{ $parcoursInfo['nom'] }}
                    </p>
                </div>
                <div class="flex flex-wrap gap-2 mt-4 sm:mt-0">
                    ...
                    <a href="{{ route('add_ue', ['niveau' => $niveauInfo['id'], 'parcour' => $parcoursInfo['id']]) }}" class="inline-flex items-center py-1.5 px-3 text-sm font-medium rounded bg-primary-600 text-white hover:bg-primary-700 focus:outline-none dark:bg-primary-700 dark:hover:bg-primary-800">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 me-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                                    ...
                                    <a href="{{ route('add_ue', ['niveau' => $niveauInfo['id'], 'parcour' => $parcoursInfo['id']]) }}" class="inline-flex items-center px-3 py-2 mt-4 text-sm font-medium text-white rounded-md bg-primary-600 hover:bg-primary-700 focus:outline-none dark:bg-primary-700 dark:hover:bg-primary-800">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 me-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                        </svg>
                                        Ajouter une UE
