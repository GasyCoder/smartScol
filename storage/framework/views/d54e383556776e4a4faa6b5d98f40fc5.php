        ...
        <div class="container max-w-none">
            <div class="relative flex items-center -mx-1">
                ...
                <div class="px-1 py-3.5 flex xl:hidden">
                    <a href="<?php echo e(url('/')); ?>" class="relative inline-block transition-opacity duration-300 h-9">
                        <img class="h-full opacity-0 dark:opacity-100" src="<?php echo e(asset('images/logo.png')); ?>" srcset="<?php echo e(asset('images/logo.png')); ?>" alt="<?php echo e(site_info('name')); ?>">
                        <img class="absolute top-0 h-full opacity-100 dark:opacity-0 start-0" src="<?php echo e(asset('images/logo.png')); ?>" srcset="<?php echo e(asset('images/logo.png')); ?>" alt="<?php echo e(site_info('name')); ?>">
                    </a>
                </div>
                            ...
                            <a tabindex="0" href="#" class="dropdown-toggle *:pointer-events-none peer inline-flex items-center group" data-offset="0,10" data-placement="bottom-end"  data-rtl-placement="bottom-start">
                                <div class="flex items-center">
                                    ...
                                    <div class="hidden md:block ms-4">
                                        <div class="text-xs font-medium leading-none pt-0.5 pb-1.5 text-primary-500 group-hover:text-primary-600"><?php echo e(Auth::user()->name); ?></div>
                                        <div class="flex items-center text-xs font-bold text-slate-600 dark:text-slate-400"><?php echo e(Auth::user()->roles->first()->name ?? 'Utilisateur'); ?> <em class="text-sm leading-none ms-1 ni ni-chevron-down"></em></div>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="hidden py-5 border-b border-gray-200 sm:block px-7 bg-slate-50 dark:bg-slate-900 dark:border-gray-800">
                                    <div class="flex items-center">
                                        ...
                                        <div class="flex flex-col ms-4">
                                            <span class="text-sm font-bold text-slate-700 dark:text-white"><?php echo e(Auth::user()->name); ?></span>
                                            <span class="mt-1 text-xs text-slate-400"><?php echo e(Auth::user()->email); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <ul class="py-3">
                                    <li>
                                        <a class="relative px-7 py-2.5 flex items-center rounded-[inherit] text-sm leading-5 font-medium text-slate-600 dark:text-slate-400 hover:text-primary-600 hover:dark:text-primary-600 transition-all duration-300" href="<?php echo e(route('setting.user_management')); ?>">
...
<?php /**PATH /var/www/smartScol/resources/views/layouts/partials/header.blade.php ENDPATH**/ ?>