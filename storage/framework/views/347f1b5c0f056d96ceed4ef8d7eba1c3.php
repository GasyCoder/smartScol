<div class="relative">
    ...
    <div class="sticky top-0 z-10 px-5 py-4">
        <div class="flex items-center justify-between">
            <!-- Titre principal -->
            <h5 class="text-xl font-medium text-slate-700 dark:text-white text-center">Unité d'enseignement/Élément Constitutif</h5>
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="items-center hidden text-sm sm:flex">
                    <span class="text-slate-600 dark:text-slate-400">
                        <!--[if BLOCK]><![endif]--><?php if($niveauInfo): ?>
                            <span class="font-medium"><?php echo e($niveauInfo['nom']); ?> (<?php echo e($niveauInfo['abr']); ?>)</span>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                        <!--[if BLOCK]><![endif]--><?php if($parcoursInfo): ?>
                            <span class="mx-2 text-slate-400">/</span>
                            <span class="font-medium"><?php echo e($parcoursInfo['nom']); ?> (<?php echo e($parcoursInfo['abr']); ?>)</span>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                        <!--[if BLOCK]><![endif]--><?php if($step === 'ue'): ?>
                            <span class="mx-2 text-slate-400">/</span>
                            <span class="font-medium text-primary-600 dark:text-primary-400">UE</span>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </span>
                </div>
                ...
                <div class="flex items-center space-x-2">
                    <!--[if BLOCK]><![endif]--><?php if($step === 'parcours'): ?>
    ...
    <div class="px-5 pt-6">
        ...
        <!--[if BLOCK]><![endif]--><?php if($step === 'niveau'): ?>
        ...
        <div class="rounded-lg shadow-sm">
            ...
            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3 max-w-4xl mx-auto">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $niveaux; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $niveau): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <button wire:click="$set('niveauId', <?php echo e($niveau->id); ?>)" 
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="w-12 h-12 bg-blue-600 rounded-lg flex items-center justify-center group-hover:bg-blue-700 transition-colors">
                                <span class="text-lg font-bold text-white"><?php echo e(substr($niveau->abr ?: $niveau->nom, 0, 2)); ?></span>
                            </div>
                            <div class="text-left">
                                <h3 class="font-semibold text-gray-900 dark:text-white"><?php echo e($niveau->nom); ?></h3>
                                <!--[if BLOCK]><![endif]--><?php if($niveau->abr): ?>
                                    <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($niveau->abr); ?></p>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                        </div>
                    </button>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
            <div class="flex items-center justify-between mb-8">
                <div class="text-center flex-1">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Niveau: <span class="font-semibold"><?php echo e($niveauInfo['nom']); ?></span></p>
                </div>
            ...
            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3 max-w-4xl mx-auto">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $parcours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parcour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <button wire:click="$set('parcoursId', <?php echo e($parcour->id); ?>)" 
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="w-12 h-12 bg-green-600 rounded-lg flex items-center justify-center group-hover:bg-green-700 transition-colors">
                                <span class="text-lg font-bold text-white"><?php echo e(substr($parcour->abr ?: $parcour->nom, 0, 2)); ?></span>
                            </div>
                            <div class="text-left">
                                <h3 class="font-semibold text-gray-900 dark:text-white"><?php echo e($parcour->nom); ?></h3>
                                <!--[if BLOCK]><![endif]--><?php if($parcour->abr): ?>
                                    <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($parcour->abr); ?></p>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                        </div>
                    </button>
        ...
        <!-- Section Unités d'Enseignement - Visible uniquement à l'étape UE -->
        <!--[if BLOCK]><![endif]--><?php if($step === 'ue' && $niveauInfo && $parcoursInfo): ?>
        <div>
            <div class="flex flex-col mb-6 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm font-bold leading-6 text-slate-400">
                        Liste des unités d'enseignement pour <?php echo e($niveauInfo['nom']); ?> - <?php echo e($parcoursInfo['nom']); ?>
                ...
                <div class="flex flex-wrap gap-2 mt-4 sm:mt-0">
                    <div class="relative">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($importFile): ?>
                        <button wire:click="importUEs" class="ml-1 inline-flex items-center py-1.5 px-3 text-sm font-medium rounded bg-primary-600 text-white hover:bg-primary-700 focus:outline-none dark:bg-primary-700 dark:hover:bg-primary-800">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 me-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    <button wire:click="exportUEs" class="inline-flex items-center py-1.5 px-3 text-sm font-medium rounded border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:outline-none dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-700">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 me-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                        </svg>
                        Exporter
                    </button>
                    <a href="<?php echo e(route('add_ue', ['niveau' => $niveauInfo['id'], 'parcour' => $parcoursInfo['id']])); ?>" class="inline-flex items-center py-1.5 px-3 text-sm font-medium rounded bg-primary-600 text-white hover:bg-primary-700 focus:outline-none dark:bg-primary-700 dark:hover:bg-primary-800">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 me-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="mb-4">
                <div class="relative">
                    <input type="text" wire:model.live.debounce.300ms="search" class="block w-full py-2 pl-10 pr-4 text-sm bg-white border border-gray-300 rounded-md dark:bg-gray-950 dark:border-gray-800 dark:text-white focus:border-primary-500 focus:ring-0 dark:focus:border-primary-600" placeholder="Rechercher une UE...">
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                    <thead>
                        <tr class="bg-gray-50 dark:bg-gray-900">
                            <th scope="col" class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase cursor-pointer dark:text-gray-400" wire:click="sortBy('abr')">
                                <div class="flex items-center space-x-1">
                                    <span>Abréviation</span>
                                    <!--[if BLOCK]><![endif]--><?php if($sortField === 'abr'): ?>
                            ...
                            <th scope="col" class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase cursor-pointer dark:text-gray-400" wire:click="sortBy('nom')">
                                <div class="flex items-center space-x-1">
                                    <span>Nom</span>
                                    <!--[if BLOCK]><![endif]--><?php if($sortField === 'nom'): ?>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <!--[if BLOCK]><![endif]--><?php if($sortDirection === 'asc'): ?>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" />
                                            <?php else: ?>
                            ...
                            <th scope="col" class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase cursor-pointer dark:text-gray-400" wire:click="sortBy('credits')">
                                Crédits
                            </th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-950 dark:divide-gray-800">
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $ues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-900">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600 whitespace-nowrap dark:text-gray-300">
                                    <?php echo e(number_format($ue->credits, 2)); ?>

                                </td>
                                <td class="px-6 py-4 text-sm text-gray-600 whitespace-nowrap dark:text-gray-300">
                                    <?php echo e($ue->ecs->count()); ?>

                                </td>
                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                    <div class="flex items-center justify-end space-x-2">
                                        <a href="<?php echo e(route('edit_ue', ['ue' => $ue['id']])); ?>" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                            </svg>
                                        </a>
                                        <button wire:click="confirmDelete(<?php echo e($ue->id); ?>)"
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="4" class="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                                    ...
                                    <p class="mt-2 text-sm font-medium">Aucune unité d'enseignement trouvée</p>
                                    <p class="mt-1 text-sm">Ajoutez une nouvelle UE pour ce parcours.</p>
                                    <a href="<?php echo e(route('add_ue', ['niveau' => $niveauInfo['id'], 'parcour' => $parcoursInfo['id']])); ?>" class="inline-flex items-center px-3 py-2 mt-4 text-sm font-medium text-white rounded-md bg-primary-600 hover:bg-primary-700 focus:outline-none dark:bg-primary-700 dark:hover:bg-primary-800">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 me-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                        </svg>
                                        Ajouter une UE
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50">
        <div class="w-full max-w-md p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
            ...
            <p class="mb-6 text-gray-700 dark:text-gray-300">Êtes-vous sûr de vouloir supprimer cette UE ? Cette action est irréversible.</p>
            <div class="flex justify-end space-x-3">
                ...
                <button wire:click="deleteUE" class="px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-md hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-800">
                    Supprimer
                </button>
            </div>
        </div>
...
<?php /**PATH /var/www/smartScol/resources/views/livewire/admin/ue/unite_element.blade.php ENDPATH**/ ?>