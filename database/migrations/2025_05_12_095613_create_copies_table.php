...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('copies', function (Blueprint $table) {
            ...
            $table->index(['code_anonymat_id', 'ec_id', 'session_exam_id'], 'idx_copies_code_ec_session');
            $table->index(['session_exam_id', 'deleted_at'], 'idx_copies_session_active');
            $table->index(['note', 'session_exam_id'], 'idx_copies_note_session');
            $table->index(['examen_id', 'session_exam_id', 'deleted_at'], 'idx_copies_fusion_lookup');
            $table->index(['ec_id', 'note', 'session_exam_id'], 'idx_copies_ec_note_session');
        });
    }
